<aside
    class="flex z-20 fixed h-screen bottom-0 left-0 space-y-6 backdrop-blur-md text-[#151C48] flex-col items-center bg-white w-[19rem] py-9 pr-10 pl-10 shadow-[4px_0px_50px_4px_rgba(198,203,232,0.1)]"
>
