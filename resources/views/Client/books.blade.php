    ...
    <div class="w-full flex justify-start flex-col h-full space-y-6 pb-4">
      ...
      <div class="flex flex-1 items-start">
        <div class="w-full grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
          ...
          <a href="{{ route('books.show', ['id' => $book->id, 'page' => request('page')]) }}" class="group bg-white/60 pb-4 px-4 py-4 rounded-xl shadow-[0px_7px_50px_0px_rgba(198,203,232,0.2)] hover:shadow-[0px_11px_50px_0px_rgba(198,203,232,0.35)] hover:scale-105 transition-all duration-300">
