...
@section('content')
    <div class="w-full">
        <div class="bg-white/60 flex flex-col items-start space-y-6 w-full pt-6 pb-10 rounded-xl shadow-[0px_7px_50px_0px_rgba(198,203,232,0.2)] px-6 lg:px-14">
          ...
          <div class="flex flex-col md:space-x-12 md:flex-row lg:space-x-0 lg:flex-col xl:flex-row xl:space-x-12">
            <div  data-tilt class="flex  js-tilt justify-center items-start rounded-xl mb-8 md:mb-4 lg:mb-8 ">
                <img class="border rounded-xl  shadow-[0px_10px_20px_0px_rgba(0,0,0,0.15)]  transition-all duration-300 w-full sm:w-80 md:w-72" src={{ $book->cover }} alt="book-img">
            </div>
