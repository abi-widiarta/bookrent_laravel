...
@section('content')
    <div class="w-full h-full flex flex-col space-y-6">
      ...
      <div class="bg-white/60 space-y-4 flex-1  w-full rounded-xl shadow-[0px_7px_50px_0px_rgba(198,203,232,0.2)] p-6 md:p-10">
        <h1 class="text-[#151C48] font-semibold text-lg md:text-xl">Rent Log List</h1>

        <div class="w-full overflow-scroll">
          <table class="table-fixed border-collapse w-[60rem] md:w-[70rem] 2xl:w-full">
            <thead>
